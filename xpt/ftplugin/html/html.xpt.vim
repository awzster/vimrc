...
XPT ng-modal
<modal-dialog show="vm.`dlg^DlgShow" dialog-title="`title^" ng-modal-class="ng-modal-avg" ng-cloak>
    <form name="vm.`dlg^Form" ng-submit="vm.`dlg^Submit()">
        <div class="panel-sm panel-default" style="max-height: calc(100vh - 10rem); overflow-y: auto;">
            ...
            <div class="panel-footer text-right">
                ...
                <button class="btn btn-default" ng-click="vm.`dlg^DlgShow = false" type="button">Close</button>
            </div>
        </div>
    </form>
</modal-dialog>
